 ...
 *
 */
class BKTCExec: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMBKTCExecSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMBKTCExecSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SBKGTC };

	/**
	 * \class BKTCExec::CEDROOMMemory
	...
	//! BKTCExec Component Port
	CEDROOMInterface	BKTCExec;
	...
	//! Constructor
	BKTCExec(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMBKTCExecSignal { EDROOMSignalTimeout,
		...
		friend class BKTCExec;

		//!component reference
		BKTCExec &EDROOMcomponent;
