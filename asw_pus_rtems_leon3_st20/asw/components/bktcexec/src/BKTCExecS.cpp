...
BKTCExec::BKTCExec(TEDROOMComponentID id,
...
bool BKTCExec::EDROOMIsComponentFinished()
{
...
void BKTCExec::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
