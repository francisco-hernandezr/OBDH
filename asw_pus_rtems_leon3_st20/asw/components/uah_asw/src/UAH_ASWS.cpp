...
bool UAH_ASW::EDROOMIsComponentFinished()
{
	...
	return ( TCManager.EDROOMIsComponentFinished() && HK_FDIRMng.EDROOMIsComponentFinished() && BKTCExec.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
